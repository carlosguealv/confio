...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    double circleRadius = MediaQuery.of(context).size.width * 0.175; // Reduced by 30%
        ...
        child: Stack(
          children: [
            Positioned(
              ...
              child: Text(
                "Confio",
                style: GoogleFonts.delaGothicOne(fontSize: 36, color: Color(0xff7893FF)),
              ),
            ),
            Positioned(
              top: 36.0,
              ...
              child: Align(
                ...
                child: CircleAvatar(
                  ...
                  backgroundImage: _image != null
                      ...
                      : AssetImage("lib/assets/images/white_circle.png"),
                ),
              ),
            ),
            Positioned(
              top: MediaQuery.of(context).size.height * 0.13 + (2 * circleRadius) - 20,
              left: MediaQuery.of(context).size.width * 0.45 + circleRadius - 20,
