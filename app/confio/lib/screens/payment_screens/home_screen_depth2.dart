...
import 'package:confio/screens/home_screen/widget/tuspagos.dart';
                          ...
                          Text.rich(
                            TextSpan(
                              children: [
                                ...
                                TextSpan(
                                  text:
                                      'S/ ${widget.overallPayment.amount * widget.overallPayment.due.length}',
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: TusPagosWidget(
                                payment: widget.overallPayment.due[index],
                                amount: widget.overallPayment.amount),
                          );
                        }),
                  )
                ],
